...
function todayFrFr(): string {
  // DD/MM/YYYY — used in the "Mise à jour automatique en date du …"
  // prefix generated by the append-situation skill. Full year avoids
  // ambiguity on timeline views that span multiple years.
