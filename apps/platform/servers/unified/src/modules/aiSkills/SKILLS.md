...
|---|---|---|---|
| `suivitess-extract-transcript` | 1 | Extraire sujets atomiques d'une transcription Fathom/Otter | [skill-extract-transcript.md](../suivitess/skill-extract-transcript.md) |
| `suivitess-extract-slack` | 1 | Extraire sujets d'un digest Slack (threads, réactions) | [skill-extract-slack.md](../suivitess/skill-extract-slack.md) |
| `suivitess-extract-outlook` | 1 | Extraire sujets d'une chaîne d'emails | [skill-extract-outlook.md](../suivitess/skill-extract-outlook.md) |
| `suivitess-place-in-document` | 2 | Décider enrich/create dans un suivitess ouvert | [skill-place-in-document.md](../suivitess/skill-place-in-document.md) |
| `suivitess-place-in-reviews` | 2 | Router vers la bonne review + section (multi-review) | [skill-place-in-reviews.md](../suivitess/skill-place-in-reviews.md) |
| `suivitess-append-situation` | 3 | Rédiger `appendText` à concaténer (enrich) | [skill-append-situation.md](../suivitess/skill-append-situation.md) |
| `suivitess-compose-situation` | 3 | Rédiger `situation` d'un nouveau sujet | [skill-compose-situation.md](../suivitess/skill-compose-situation.md) |
...
- **Fichier** : [skill-reformulate-subject.md](../suivitess/skill-reformulate-subject.md)
...
- **Fichier** : [skill-reorganize-board.md](../delivery/skill-reorganize-board.md)
...
- **Fichier** : [skill-llm-judge-faithfulness.md](./skill-llm-judge-faithfulness.md)
...
2. Ajouter une entrée dans `registry.ts` :
   ```ts
   {
     ...
     defaultFilePath: resolve(MODULES_DIR, 'mon-module/skill-mon-skill.md'),
   }
   ```
